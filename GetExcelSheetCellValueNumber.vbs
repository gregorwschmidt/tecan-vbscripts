...
strExcelFileNamePath = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueNumber_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueNumber_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueNumber_Column"))
strSheetName = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueNumber_SheetName"))
...
If fso.FileExists(strExcelFileNamePath) Then
	...
	Evoware.SetDoubleVariable "VBScript_GetExcelSheetCellValueNumber_Number", floExcelOutputValue
