Option Explicit
Dim strExcelPath, oXL, oXLBook, oXLSheet, bReadOnly, objShell, intExcelRow, intExcelColumn, doubleExcelInputValue, strSheetName

' Read values from evoware
strExcelPath = cstr(Evoware.GetStringVariable("VBScript_SetExcelSheetCellValueNumber_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_SetExcelSheetCellValueNumber_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_SetExcelSheetCellValueNumber_Column"))
doubleExcelInputValue = Evoware.GetDoubleVariable("VBScript_SetExcelSheetCellValueNumber_Number")
strSheetName = cstr(Evoware.GetStringVariable("VBScript_SetExcelSheetCellValueNumber_SheetName"))
