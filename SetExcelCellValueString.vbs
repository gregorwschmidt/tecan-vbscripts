Option Explicit
Dim strExcelPath, oXL, oXLBook, oXLSheet, bReadOnly, objShell, intExcelRow, intExcelColumn, strExcelInputValue

' Read values from evoware
strExcelPath = cstr(Evoware.GetStringVariable("VBScript_SetExcelCellValueString_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_SetExcelCellValueString_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_SetExcelCellValueString_Column"))
strExcelInputValue = cstr(Evoware.GetStringVariable("VBScript_SetExcelCellValueString_String"))
