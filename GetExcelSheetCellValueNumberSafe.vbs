Option Explicit
Dim strExcelFileNamePath, oXL, oXLBook, oXLSheet, objShell, intExcelRow, intExcelColumn, floExcelOutputValue, strSheetName
Dim fso, strExcelFilePath, Temp, strFileExtension, strExcelCopyFileNamePath, dateTime, intReturnCode

' Read values from evoware
strExcelFileNamePath = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueNumberSafe_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueNumberSafe_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueNumberSafe_Column"))
strSheetName = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueNumberSafe_SheetName"))
...
If fso.FileExists(strExcelFileNamePath) Then
	...
	floExcelOutputValue = cdbl(oXLSheet.Cells(intExcelRow, intExcelColumn).Value)
	
	'Handover value to EVOware
	Evoware.SetDoubleVariable "VBScript_GetExcelSheetCellValueNumberSafe_Number", floExcelOutputValue
...
Evoware.SetDoubleVariable "VBScript_GetExcelSheetCellValueNumberSafe_ReturnCode", intReturnCode
