Option Explicit
Dim strExcelPath, oXL, oXLBook, oXLSheet, bReadOnly, objShell, intExcelRow, intExcelColumn, strExcelInputValue, strSheetName

' Read values from evoware
strExcelPath = cstr(Evoware.GetStringVariable("VBScript_SetExcelSheetCellValueString_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_SetExcelSheetCellValueString_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_SetExcelSheetCellValueString_Column"))
strExcelInputValue = cstr(Evoware.GetStringVariable("VBScript_SetExcelSheetCellValueString_String"))
strSheetName = cstr(Evoware.GetStringVariable("VBScript_SetExcelSheetCellValueString_SheetName"))
...
oXLSheet.Cells(intExcelRow, intExcelColumn).Value = strExcelInputValue
'Save and quit.
