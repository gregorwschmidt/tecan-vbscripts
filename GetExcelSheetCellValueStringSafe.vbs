...
strExcelFileNamePath = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueStringSafe_FileNamePath"))
intExcelRow = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueStringSafe_Row"))
intExcelColumn = cint(Evoware.GetDoubleVariable("VBScript_GetExcelSheetCellValueStringSafe_Column"))
strSheetName = cstr(Evoware.GetStringVariable("VBScript_GetExcelSheetCellValueStringSafe_SheetName"))
...
If fso.FileExists(strExcelFileNamePath) Then
	...
	Evoware.SetStringVariable "VBScript_GetExcelSheetCellValueStringSafe_String", cstr(strExcelOutputValue)
...
Evoware.SetDoubleVariable "VBScript_GetExcelSheetCellValueStringSafe_ReturnCode", intReturnCode
